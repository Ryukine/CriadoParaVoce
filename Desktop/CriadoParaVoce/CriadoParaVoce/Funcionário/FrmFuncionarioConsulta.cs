...
{
    public partial class FrmFuncionarioConsulta : Telas.Modelo.FrmModeloConsulta
    {
        ...
        private void CarregarDadosGrid(Object o, EventArgs e)
        {
            ...
            dataGridView1.DataSource = usu.Listar(txtPesquisa.Text.Trim().ToUpper(), TipoStatus).Tables[0];
        ...
        private void AbrirForm(Object o, EventArgs e)
        {
            try
            {
                ...
                CriadoParaVoce.Funcionário.FrmFuncionarioCadastro ffc = new CriadoParaVoce.Funcionário.FrmFuncionarioCadastro();
                ...
                if (o == btnAlterar || o == btnConsultar)
                {
                    ...
                    ffc.CodigoLogadoFunc = Convert.ToInt32(dataGridView1.CurrentRow.Cells[4].Value);
